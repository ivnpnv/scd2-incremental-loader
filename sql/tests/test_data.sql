...
INSERT INTO punov_meta(schema_name, table_name, max_update_dt)
...
INSERT INTO punov_source (id, val, update_dt) VALUES 
(1, 'A', CURRENT_TIMESTAMP),
(2, 'B', CURRENT_TIMESTAMP);

--2. Обновление и добавление новых записей
UPDATE punov_source SET val = 'A_updated', update_dt = CURRENT_TIMESTAMP WHERE id = 1;
INSERT INTO punov_source (id, val, update_dt) VALUES (3, 'C', CURRENT_TIMESTAMP);

--3. Удаление записей
DELETE FROM punov_source WHERE id = 2;